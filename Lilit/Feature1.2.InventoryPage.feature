...
Background:
   ...
   @smoke
   Scenario Outline: 1.2.01: User sould be able to add one/several and all items into the cart on the Inventory page
   ...
   @sanity
   Scenario Outline: 1.2.02: User sould be able to remove one/several and all items from the cart on the Inventory page
