...
@Sanity                                                                                                  
Scenario Outline: 1.3.1.2 User should be able to delete items from the cart                                
...
@Regression                                                                                              
Scenario: 1.3.1.3 User should be able to continue shopping after adding goods into the cart                
...
@Smoke                                                                                                   
Scenario: 1.3.1.4 User should be redirected to the "Checkout information" page                             
    Given user went to "Cart" page                                                                       
