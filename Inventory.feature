...
Scenarion: 1.2_3. User should be able to add several items into the cart
Given application URL is opened with Inventory page on main page
...
Scenarion: 1.2_4 User should be able to add all items into the cart
Given application URL is opened with Inventory page on main page
...
Scenarion: 1.2_5 User should be able to remove one item from the cart
Given application URL is opened with Inventory page on main page
...
Scenarion: 1.2_6 User should be able to remove several items from the cart
Given application URL is opened with Inventory page on main page
When user press 'Cart' button to see added items
...
Scenarion: 1.2_7 User should be able to remove all items from the cart
Given application URL is opened with Inventory page on main page
When user press 'Cart' button to see added items
